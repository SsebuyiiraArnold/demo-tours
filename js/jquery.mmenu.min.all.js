!(function (e) {
  ...
  function s() {
    (r.$wndw = e(window)),
      ...
      d.add(
        "menu ismenu panel list subtitle selected label spacer current highest hidden smooth blocker modal background opened opening subopened subopen fullsubopen subclose"
      ),
      (d.umm = function (e) {
    ...
    r.$wndw.on(u.resize, function (e, t) {
      if (t || r.$html.hasClass(d.opened)) {
        var s = r.$wndw.height();
        (t || s != n) && ((n = s), r.$smooth.css("minHeight", s));
      }
    }),
      (e[a]._c = d),
      (e[a]._d = c),
      ...
      (e[a].prototype = {
        ...
        _openSetup: function () {
          (h = r.$wndw.scrollTop() || 0),
            ...
            r.$smooth.data(c.style, r.$smooth.attr("style") || ""),
            ...
            ? (i(
                ...
                function () {
                  e.$menu.removeClass(d.current).removeClass(d.opened),
                    ...
                    r.$smooth.attr("style", r.$smooth.data(c.style)),
                    (e.opened = !1),
        ...
        _initPage: function (n) {
          n ||
            ...
            n.length > 1 &&
              (e[a].debug(
                "Multiple nodes found for the smooth-node, all nodes are wrapped in one <" +
  ...
  (e[a].prototype["_addon_" + o] = function () {
    ...
    if (e.fn.hammer) {
      ...
      if (
        ...
        var u = this.__valueOrFn(r.pageNode, this.$menu, d.$smooth);
          ...
          .on(s.touchstart + " " + s.mousedown, function (e) {
            if ("touchstart" == e.type)
              var t =
                ...
                a = t[f.smooth];
            else if ("mousedown" == e.type) var a = e[f.smooth];
...
$("#menu").mmenu({
  position: "right",
  slidingSubmenus: false, // Disable horizontal sliding for submenus
  zposition: "front", // Ensure it stays in front of other content
});
