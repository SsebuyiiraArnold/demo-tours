var elementorFrontendConfig = {
  ...
  nonces: { floatingButtonsClickTracking: "0ea0851c2e" },
  swiperClass: "swiper",
  settings: { smooth: [], editorPreferences: [] },
  kit: {
  ...
  post: {
    id: 3662,
    title:
      "14%20Days%20Explore%20Uganda%20And%20Rwanda%20Gorilla%20Trekking%20Safari%20%7C%20Trion%20Safaris%20And%20Tours",
    excerpt: "",
    featuredImage: false,
  },
};
    ...
    8135: (e, t) => {
      ...
      class _default extends elementorModules.ViewModule {
        ...
        getDocumentSettings(e) {
          ...
          if (this.isEdit) {
            t = {};
            const e = elementor.settings.smooth.model;
          ...
          (this.$element = this.getSettings("$element")),
            ...
            this.isEdit
              ? elementor.on("document:loaded", () => {
                  elementor.settings.smooth.model.on(
                    "change",
