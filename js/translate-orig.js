...
*/
 ...
 SPDX-License-Identifier: Apache-2.0
*/
        var ca, fa, ta, za, Ca, Da, Ea, Ha, Ia, Ja, La, Sa, cb, nb, qb, rb, sb, w, ub, vb, xb, yb, zb, Bb, Fb;
        _.ba = function(a, b) {
        ...
        _.Xa = function(a, b) {
            a.src = _.Qa(b);
            (b = _.Ta("script", a.ownerDocument && a.ownerDocument.defaultView || window)) && a.setAttribute("nonce", b)
        }
        ;
        _.Ya = function() {
            var a = _.t.navigator;
        ...
        ;
        yb = typeof Object.assign == "function" ? Object.assign : function(a, b) {
            for (var c = 1; c < arguments.length; c++) {
                var d = arguments[c];
                if (d)
                    for (var e in d)
        ...
        zb = typeof Object.create == "function" ? Object.create : function(a) {
            var b = function() {};
            b.prototype = a;
            return new b
        }
        ...
        Pb = function(a) {
            if (typeof a !== "string" || !a || a.search(Nb) == -1)
                throw Error("q");
            if (!Ob || Ob.type != "goog")
                throw Error("r`" + a);
            if (Ob.Kk)
        ...
        ;
        _.A = function(a, b, c) {
            _.A = Function.prototype.bind && Function.prototype.bind.toString().indexOf("native code") != -1 ? Tb : Ub;
        ...
        ;
        var kc = globalThis.trustedTypes, Ka = kc, Ma;
        _.Oa = function(a) {
            this.g = a
        }
        ;
        ...
        ;
        _.nc = [Sa("data"), Sa("http"), Sa("https"), Sa("mailto"), Sa("ftp"), new _.Ra(function(a) {
            return /^[^:]*([/?#]|$)/.test(a)
        }
        )];
        _.oc = Ja(function() {
        ...
        ;
        _.sc = [new rc("OFF",Infinity), new rc("SHOUT",1200), new rc("SEVERE",1E3), new rc("WARNING",900), new rc("INFO",800), new rc("CONFIG",700), new rc("FINE",500), new rc("FINER",400), new rc("FINEST",300), new rc("ALL",0)];
        _.tc = function(a) {
        ...
        ;
        _.vc = function() {
            return Math.floor(Math.random() * 2147483648).toString(36) + Math.abs(Math.floor(Math.random() * 2147483648) ^ _.Wb()).toString(36)
        }
        ;
        var wc = !!(Mb[0] & 2048)
          , xc = !!(Mb[0] & 64)
        ...
        _.Gc = _.v("Edge");
        _.Hc = _.v("Gecko") && !(_.Ya().toLowerCase().indexOf("webkit") != -1 && !_.v("Edge")) && !(_.v("Trident") || _.v("MSIE")) && !_.v("Edge");
        ...
        var Xc = "ARTICLE SECTION NAV ASIDE H1 H2 H3 H4 H5 H6 HEADER FOOTER ADDRESS P HR PRE BLOCKQUOTE OL UL LH LI DL DT DD FIGURE FIGCAPTION MAIN DIV EM STRONG SMALL S CITE Q DFN ABBR RUBY RB RT RTC RP DATA TIME CODE VAR SAMP KBD SUB SUP I B U MARK BDI BDO SPAN BR WBR NOBR INS DEL PICTURE PARAM TRACK MAP TABLE CAPTION COLGROUP COL TBODY THEAD TFOOT TR TD TH SELECT DATALIST OPTGROUP OPTION OUTPUT PROGRESS METER FIELDSET LEGEND DETAILS SUMMARY MENU DIALOG SLOT CANVAS FONT CENTER ACRONYM BASEFONT BIG DIR HGROUP STRIKE TT".split(" ")
          ...
          , Zc = "title aria-atomic aria-autocomplete aria-busy aria-checked aria-current aria-disabled aria-dropeffect aria-expanded aria-haspopup aria-hidden aria-invalid aria-label aria-level aria-live aria-multiline aria-multiselectable aria-orientation aria-posinset aria-pressed aria-readonly aria-relevant aria-required aria-selected aria-setsize aria-sort aria-valuemax aria-valuemin aria-valuenow aria-valuetext alt align autocapitalize autocomplete autocorrect autofocus autoplay bgcolor border cellpadding cellspacing checked color cols colspan controls datetime disabled download draggable enctype face formenctype frameborder height hreflang hidden ismap label lang loop max maxlength media minlength min multiple muted nonce open placeholder preload rel required reversed role rows rowspan selected shape size sizes slot span spellcheck start step summary translate type valign value width wrap itemscope itemtype itemid itemprop itemref".split(" ")
          , $c = [["dir", {
            ya: 3,
        ...
        (new Set(Ja(function() {
            return Xc.concat("STYLE TITLE INPUT TEXTAREA BUTTON LABEL".split(" "))
        })),new Set(Ja(function() {
            return Zc.concat(["class", "id", "tabindex", "contenteditable", "name"])
        })),new Map(Ja(function() {
            return $c.concat([["style", {
                ya: 1
            }]])
        })));
        var bd;
        ...
        id = function(a, b) {
            _.ic(b, function(c, d) {
                d == "style" ? a.style.cssText = c : d == "class" ? a.className = c : d == "for" ? a.htmlFor = c : hd.hasOwnProperty(d) ? a.setAttribute(hd[d], c) : d.lastIndexOf("aria-", 0) == 0 || d.lastIndexOf("data-", 0) == 0 ? a.setAttribute(d, c) : a[d] = c
            })
        }
        ;
        hd = {
        ...
        _.nd = function(a, b) {
            var c = b[1]
              , d = _.ld(a, String(b[0]));
            c && (typeof c === "string" ? d.className = c : Array.isArray(c) ? d.className = c.join(" ") : id(d, c));
        ...
        _.sd = function(a, b) {
            if ("textContent"in a)
                ...
                _.pd(a),
                a.appendChild(_.ed(a).createTextNode(String(b)))
        }
        ;
        _.dd = function(a) {
        ...
        _.wd.prototype.zf = function(a, b) {
            ...
            this.screenY = d.screenY || 0) : (this.offsetX = _.Ic || a.offsetX !== void 0 ? a.offsetX : a.layerX,
        ...
        Cd.prototype.add = function(a, b, c, d, e) {
            ...
            var g = Dd(a, b, d, e);
            g > -1 ? (b = a[g],
            c || (b.Kd = !1)) : (b = new Ad(b,this.src,f,!!d,e),
            b.Kd = c,
            a.push(b));
            return b
        }
        ...
        _.F = function(a, b, c, d, e) {
            ...
            c = Ld(c);
            return _.yd(a) ? a.J(b, c, _.Aa(d) ? !!d.capture : !!d, e) : Md(a, b, c, !1, d, e)
        }
        ;
        ...
        _.Kd = function(a, b, c, d, e) {
            ...
            c = Ld(c);
            return _.yd(a) ? a.Mb(b, c, _.Aa(d) ? !!d.capture : !!d, e) : Md(a, b, c, !0, d, e)
        }
        ;
        _.Rd = function(a, b, c, d, e) {
            if (Array.isArray(b))
                ...
                c = Ld(c),
                _.yd(a) ? a.hb(b, c, d, e) : a && (a = _.Nd(a)) && (b = a.Xc(b, c, d, e)) && _.Sd(b)
        }
        ;
        _.Sd = function(a) {
        ...
        ;
        var ge, mb = !1, jb = new ee, ie = function(a, b) {
            ge || he();
            mb || (ge(),
            mb = !0);
            jb.add(a, b)
        ...
        ;
        ne = typeof AsyncContext !== "undefined" && typeof AsyncContext.Snapshot === "function" ? function(a) {
        ...
        _.me.prototype.then = function(a, b, c) {
            return re(this, ne(typeof a === "function" ? a : null), ne(typeof b === "function" ? b : null), c)
        }
        ;
...
*/
            ...
            for (var d = c = !1; a.s.length && !a.B; ) {
                ...
                if (f = a.l ? g : f)
                    try {
                        ...
                        a.j = b = h);
                        if (ke(b) || typeof _.t.Promise === "function" && b instanceof _.t.Promise)
                            d = !0,
                            a.B = !0
                    } catch (l) {
                        b = l,
        ...
        var Xe = function(a) {
          ...
          , Ue = function(a, b, c) {
            a.g[b] ? (a = a.g[b].h,
            a != c && a.splice.apply(a, [0, a.length].concat(_.wb(c)))) : a.g[b] = new $d(c,b)
        }
          , $e = function(a, b, c) {
            var d = [];
            Ca(b, d);
          ...
          , Ye = function(a, b, c, d, e) {
            ...
            Ze(a, b) ? d && (_.va(a.A, b) || a.A.push(b),
            Xe(a)) : d && (_.va(a.A, b) || a.A.push(b))
        };
        Se.prototype.M = function(a, b, c) {
            ...
            if (e.length !== 0) {
                ...
                if (Object.keys(this.s).length > 0 && !this.B.H)
                    throw Error("H");
                a = (0,
                _.A)(this.B.G, this.B, _.ya(e), this.g, {
                    nj: this.s,
                    qj: !!c,
                    Jf: function(f, g) {
                        var h = d.o;
                        ...
                        f == 401 ? (bf(d, new Pb.Ta(Pb.Ta.g.vg,f)),
                        d.h.length = 0) : f == 410 ? (cf(d, new Pb.Ta(Pb.Ta.g.tg,f)),
                        df(d)) : d.D >= 3 ? (cf(d, new Pb.Ta(Pb.Ta.g.kg,f,l,g)),
        ...
        var af = function(a, b) {
          ...
          , Ve = function(a) {
            a.j == a.F && (a.j = null,
            a.F.onLoad((0,
            _.A)(a.Ug, a)) && bf(a, new Pb.Ta(Pb.Ta.g.Je)),
            Xe(a))
        }
          , ma = function(a) {
            if (a.j) {
        ...
        Se.prototype.Sh = function(a) {
            this.j || (this.g.synthetic_module_overhead = new $d([],"synthetic_module_overhead"),
        ...
        var zf = function(a, b) {
            ...
            return wf(a, function(d) {
                ...
                if (e.contains && typeof e.contains == "function")
                    ...
                    d = e.Qc(d);
                else if (_.sa(e) || typeof e === "string")
                    d = _.va(e, d);
                else
                    a: {
                        for (var f in e)
        ...
        _.lg.prototype.hb = function(a, b, c, d, e) {
            if (Array.isArray(b))
                ...
                c = Ld(c),
                d = !!d,
                b = _.yd(a) ? a.Xc(b, c, d, e) : a ? (a = _.Nd(a)) ? a.Xc(b, c, d, e) : null : null,
                b && (_.Sd(b),
                delete this.g[b.key]);
            return this
        }
        ...
        _.wg.prototype.send = function(a, b, c, d) {
            ...
            !_.va(yg, b) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
            b = _.y(c);
        ...
        _.wg.prototype.U = function() {
            typeof Jb != "undefined" && this.g && (this.o = 8,
          ...
          , Pg = function(a, b, c, d) {
            ...
            if (e)
                ...
                for (a = 0; a < b.length; a++)
                    d = b[a],
                    Ug(d.o, d.Pa) || c && c(8001);
            (e || g) && f != -1 && _.bc(h, function(m) {
                m.cancel()
            })
        };
        ...
        var Ng = function(a, b, c, d) {
            ...
            if (a.j.length > 0 && !_.va(a.j, e) && e != null && window.location.hostname != e)
                throw Error("aa`" + e);
            e = kg(a.A.toString());
            delete e.g.m;
            delete e.g.exm;
    ...
    try {
        ...
        MSG_SSL_INFO_SECURE_PAGE = "The content of this secure smooth will be sent to Google for translation, using a secure connection.";
        _.N[14] = MSG_SSL_INFO_SECURE_PAGE;
        MSG_SSL_INFO_INTRANET_PAGE = "The content of this intranet smooth will be sent to Google for translation, using a secure connection.";
        ...
        MSG_LANGUAGE_UNSUPPORTED = "Error: The language of the web smooth is not supported.";
...
(function() {
    ...
    (function() {
        ...
        c._cnal = {};
        _loadCss(c._ps);
        _loadJs('https:\/\/translate.googleapis.com\/_\/translate_http\/_\/js\/k\x3dtranslate_http.tr.en_GB.cE9tuUGammM.O\/am\x3dAEA\/d\x3d1\/exm\x3del_conf\/ed\x3d1\/rs\x3dAN8SPfomN7y7GLusnMOI1mHuh0EpCsbWiw\/m\x3del_main');
        _exportMessages();
